...
The Rjindael Cipher was implemented using System::Security::Cryptography library in VS2010. AES-128 was used in CBC mode and PKCS7 padding for encryption and decryption of the plain text.
...
* Rjindael Cipher was implemented using System::Security::Cryptography library in VS2010.
* .NET Framework v4 is required to execute the binary file that is available in the Downloads section.
